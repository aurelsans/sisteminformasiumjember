...
<body class="font-sans">
    ...
    <!-- end drawer-->
      ...
      <!-- QQQQQQQQQQQQQQQQQQQ START MANAJEMEN QQQQQQQQQQQQQQQQQQQQQQQQQ --------------------------------------------------------- -->
         <div class="py-12 px-4 mx-auto max-w-screen-xl text-center lg:py-20"></div>

         <!-- ====== Page Title Section Start -->
         <section class="dark:bg-dark bg-white py-[40px]">
            <div class="mx-auto px-4 sm:container">
               <div class="border-primary border-l-[5px] pl-5">
                  <h2 class="text-dark mb-2 text-4xl font-semibold dark:text-white">
         ...
         <section class="bg-white dark:bg-gray-900">
            <div class="bg-fixed">
               <img class="h-auto max-w-full rounded-lg" src="/gambar/bagan.png" alt="">
            </div>
         </section>
      ...
      <!-- QQQQQQQQQQQQQQQQQQQ END MANAJEMEN QQQQQQQQQQQQQQQQQQQQQQQQQ  ----------------------------------------------------------------------------------- -->
