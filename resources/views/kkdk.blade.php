...
<body class="font-sans">
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-8"></div>
    
    <nav aria-label="breadcrumb" class="block w-full">
  <ol class="mt-14 flex flex-wrap items-center w-full px-12 rounded-md bg-blue-gray-50 bg-opacity-60">
    <li
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-8">
                <div class=" grid lg:grid-cols-2 gap-4">
                    <button
                        class="w-full lg:max-w-xl p-5 space-y-8 sm:p-8 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg shadow-xl dark:bg-gray-800">
