...
<body class="font-sans">
    ...
    <div class="py-16 px-4 mx-auto max-w-screen-xl text-center lg:py-16"></div>
...
<section class="container mx-auto px-6 mb-10" >
    ...
    <div class="flex justify-center">
        <div class="lg:w-2/3 space-y-5 text-center">
            <h1 class="text-2xl text-gray-800 uppercase tracking-widest">Layanan Mahasiswa</h1>
            <div class="h-0.5 bg-primary w-14 mx-auto"></div>
            <p class="text-gray-400">
                     Layanan Mahasiswa Sistem Informasi merujuk pada sekelompok layanan yang
                     disediakan oleh Universitas kepada mahasiswa.
                     Tujuan utamanya adalah untuk memberikan akses, mendukung, dan memfasilitasi berbagai kebutuhan
                     mahasiswa sepanjang perjalanan akademik dan administratif mereka di Universitas Muhammadiyah.
            </p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-20 ">
        <div>
            ...
            <div class="transition-all ease-in-out duration-300 hover:-translate-y-4">
                <img src="gambar/sia.png" class="mb-4" alt="Blog img-1">

                <h1 class="mb-2">
                    <a href="http://sia.unmuhjember.ac.id/" target="_blank" class="text-xl hover:text-blue-500">Sistem Informasi Akademik (SIA)</a>
                </h1>
            </div>
        </div>
        ...
        <div>
            <!-- Blog 2 -->
            <div class="transition-all ease-in-out duration-300  hover:-translate-y-4">
                <img src="/gambar/jurnalunmuh.png" class="mb-4" alt="Blog img-2">

                <h1 class="mb-2">
                    <a href="http://jurnal.unmuhjember.ac.id/" target="_blank" class="text-xl hover:text-blue-500">Jurnal Online Universitas Muhammadiyah Jember (EISSN)</a>
                </h1>
        ...
        <div>
            <!-- Blog 3 -->
            <div class="transition-all ease-in-out duration-300  hover:-translate-y-4">
                <img src="/gambar/perpuslog.png" class="mb-4" alt="Blog img-3">
                
                <h1 class="mb-2">
                    <a href="https://perpustakaan.unmuhjember.ac.id/id/" target="_blank" class="text-xl hover:text-blue-500">Sistem Informasi Perpustakaan</a>
                </h1>
