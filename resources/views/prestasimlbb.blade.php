...
<body class="font-sans">
                        ...
                        <li role="presentation">
                            ...
                            <div id="dropdownNavbarTentang"
                                ...
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="tentang-tab">
                                    ...
                                    <li class="hidden">
                                        <a href="/kontak" id="kontak-tab" data-tabs-target="#kontak" type="button"
                                            role="tab" aria-controls="kontak" aria-selected="false"
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-12 px-4 mx-auto max-w-screen-xl text-center lg:py-20"></div>

        <div class="py-10 px-16 mx-auto max-w-screen-xl lg:py-8">
            <div class="bg-white dark:bg-gray-900">
                <div class="mx-auto px-4 sm:container">
                    <div class="border-blue-100 border-l-[5px] pl-5">
                        <div class="mx-auto max-w-screen-xl">
                            <div class="mx-auto max-w-screen-xl mx-auto sm:container flex items-center">
                                <h2
                        ...
                        <p class="ml-8 text-body-color dark:text-dark-6 text-sm font-medium">
                            Meskipun relatif baru, Program Studi Sistem Informasi Universitas Muhammadiyah Jember
                            telah menorehkan sejumlah prestasi dalam berbagai kompetisi nasional dan internasional.
                            Dengan semangat keberanian dan
                            tekad untuk mencapai keunggulan, Program Studi Sistem Informasi berhasil mengukir prestasi
                            luar biasa baik di bidang pengetahuan maupun akademik.
                        </p>
                    </div>
                </div>

                <div class="py-8 px-8 mx-auto max-w-screen-xl lg:py-8"></div>
                <div class="px-4 grid grid-rows-2 lg:grid-flow-col lg:gap-4">
                    <div class="xs:px-4 xs:mb-4 xs:row-span-3">
                        <article
                            ...
                            <div
                                ...
                                <div>
                                    <a class="relative z-10 font-medium tracking-widest text-blue-700 uppercase duration-300 ease-in-out text-xs transition-color hover:text-blue-600">
                                    7 Desember 2022.
                                    </a>
                                    ...
                                    <h3
                                        ...
                                        <a href="prestasi">
                                            ...
                                            <span class="sr-only">China-ASEAN Education Cooperation Week</span>
                                        </a>
                                    </h3>

                                    <p class="block mt-4 text-base leading-relaxed text-gray-500">
                                    2022 China-ASEAN Education Cooperation Week, 2ⁿᵈ International Invitational Contest of Internet of 
                                    Things Technology diadakan pada tanggal 7 Desember 2022.
                                    </p>
                                </div>
                            </div>
                        </article>
                    </div>
                    <div class="xs:col-span-8">
                        <!-- Container for demo purpose -->
                        <div class="container mx-auto md:px-6">
                            <!-- Section: Design Block -->
                            <section>
                                <img src="gambar/fotoprestasi1.jpg"
                                    class="mb-6 w-full h-96 object-cover rounded-lg shadow-lg dark:shadow-black/20" alt="image" />

                                <div class="mb-6 flex items-center">
                                    <div>
                                        <span> Published <u>03.03.2024</u> by </span>
                                        <a class="font-medium">Universitas Muhammadiyah Jember</a>
                                    </div>
                                </div>

                                <h1 class="mb-6 text-3xl font-bold">
                                Juara 1 E-Sports MLBB SISFO CUP 2023 Se-Jawa Timur
                                </h1>

                                   <p class=" mt-4 indent-8">
                                    Pada bulan September 2023, di Jawa Timur, sebuah kompetisi e-Sports MLBB yang dikenal sebagai SISFO CUP 
                                    diselenggarakan untuk para mahasiswa. Kompetisi ini menjadi ajang yang dinanti-nanti oleh para pemain MLBB 
                                    (Mobile Legends: Bang Bang) di wilayah Jawa TImur.
                                    </p>

                                    <p class="indent-8 mt-2">Di tengah antusiasme yang tinggi, para pemain bersaing untuk mendapatkan gelar juara. Dalam ajang tersebut, 
                                    tim Mahasiswa Universitas Muhammadiyah Jember Prodi Sistem Informasi yang menonjol berhasil meraih gelar juara 
                                    pertama dalam kategori Mahasiswa. Mereka bukan hanya mengandalkan 
                                    keterampilan individu, tetapi juga kerja sama tim yang solid dan strategi yang matang.
                                    </p>

                                    <p class="indent-8 mt-2">Keberhasilan tim Mahasiswa Universitas Muhammadiyah Jember Prodi Sistem Informasi sebagai juara
                                    pertama di SISFO CUP 2023 tidak hanya membanggakan bagi tim itu sendiri, tetapi 
                                    juga untuk Universitas Muhammadiyah Jember. Prestasi tersebut juga dapat menjadi inspirasi 
                                    bagi para pemain MLBB lainnya di wilayah Jawa Timur untuk terus mengasah kemampuan dan berkompetisi 
                                    secara fair dan sportif.</p>
