...
<!-- OOOOOOOOOOOOOOOOOOO START RISET OOOOOOOOOOOOOOOOOOOO ----------------------------------------------------------------------------------- -->

         <section class="bg-white dark:bg-gray-900">
            <div class="py-12 mx-auto max-w-screen-xl text-center lg:py-10"></div>
         </section>

         <section
            class="bg-fixed bg-center bg-no-repeat radial-gradient(at right top, rgb(17, 24, 39), rgb(100, 116, 139), rgb(243, 244, 246)) bg-blue-700 bg-blend-multiply">
  ...
  <ol class="mt-12 flex flex-wrap items-center w-full px-12 rounded-md bg-blue-gray-50 bg-opacity-60">
    ...
    <li
      ...
      <span>Riset</span>
         ...
         <section class="bg-white dark:bg-gray-900">
            <div class=" mx-auto max-w-screen-xl">
               <ul id="tabs-tab" data-tabs-toggle="#tabs-tab-content" role="tabslist">
                  <div class="relative">
                     <div id="tabs" class="font-sans py-12 px-4 mx-auto max-w-screen-xl lg:py-8 relative">

                        <!-- Penelitian & Pengabdian -->
                        <header class="flex items-end text-sm">
                           <li class="me-2" role="presentation">
                              <button class="border border-b-0 px-3 py-1 text-sm focus:outline-none bg-white"
                                 id="neliti-tab" data-tabs-target="#neliti" type="button" role="tab"
                                 aria-controls="neliti" aria-selected="false">Penelitian</button>
                           </li>
                           <li class="me-2" role="presentation">
                              <button class="border border-b-0 px-3 py-1 text-sm focus:outline-none bg-white"
                                 id="pengabdian-tab" data-tabs-target="#pengabdian" type="button" role="tab"
                                 aria-controls="pengabdian" aria-selected="false">Pengabdian</button>
                           </li>
                        </header>
                        <div class="border p-2 rounded-b-xl bg-white rounded-lg shadow" id="tabs-tab-content">
                           <div id="neliti" role="neliti" aria-labelledby="neliti-tab">
                              <li class="px-4 py-2">
                                 <a href="https://geomatejournal.com/geomate/article/download/3506/2974" target="_blank"
                                    class="hover:underline hover:text-blue">Physical Model and Validation Of Local Scour
                                    Pattern Downstream Of Trapezoidal Threshold</a>
                                 <p class="text-xs text-gray-500 line-clamp-3">Ilham Saifudin S.Pd., M.Si - 2022/10/30 -
                                    GEOMATE Journal</p>
                                 <div class="border"></div>
                              </li>
                              <li class="px-4 py-2">
                                 <a href="#" target="_blank" class="hover:underline hover:text-blue">Determination Of
                                    Bulog Regional Sub-Division in East Java Using Connected Domination Number
                                    Theory</a>
                                 <p class="text-xs text-gray-500 line-clamp-3">Ilham Saifudin S.Pd., M.Si - Journal of
                                    Physics: Conference Series</p>
                                 <div class="border"></div>
                              </li>
                              <li class="px-4 py-2">
                                 <a href="https://journal.unugiri.ac.id/index.php/JaMES/article/download/557/768"
                                    target="_blank" class="hover:underline hover:text-blue">Penerapan Teori Bilangan
                                    Dominasi Jarak Dua Pada Pemilihan Lokasi Pangkal Ojek Online</a>
                                 <p class="text-xs text-gray-500 line-clamp-3">Ilham Saifudin S.Pd., M.Si - 2022/10/7 -
                                    Journal of Mathematics Education and Science</p>
                                 <div class="border"></div>
                              </li>
                              <li class="px-4 py-2">
                                 <a href="http://jurnal.unmuhjember.ac.id/index.php/JST/article/download/8770/4191"
                                    target="_blank" class="hover:underline hover:text-blue">Kelayakan Pengajuan Pinjaman
                                    Atau Kredit Pada Koperasi Ganesha Menggunakan Algoritma C4. 5</a>
                                 <p class="text-xs text-gray-500 line-clamp-3">Deni Arifianto M.Kom. & Qurrota A'yun
                                    M.Pd- 25/11/2022 - Jurnal Smart Teknologi</p>
                                 <div class="border"></div>
                              </li>
                              <li class="px-4 py-2">
                                 <a href="https://jurnal.universitasputrabangsa.ac.id/index.php/jasrd/article/download/242/161"
                                    target="_blank" class="hover:underline hover:text-blue">Model Sistem Dinamis
                                    Pengaruh Ketersediaan Lahan terhadap Peningkatan Produksi Pangan untuk Mendukung
                                    Ketahanan Pangan: a Systematic Literature Review</a>
                                 <p class="text-xs text-gray-500 line-clamp-3">Nanda Kurnia Wardati S.Kom, M.Kom -
                                    2022/12/29 - Journal of Agribusiness Science and Rural Development</p>
                                 <div class="border"></div>
                              </li>
                           </div>
                           <div id="pengabdian" role="pengabdian" aria-labelledby="pengabdian-tab">
                              <li class="px-4 py-2">
                                 <a href="http://ejurnal.unmuhjember.ac.id/index.php/ABDIMASTEK/article/download/206/47"
                                    target="_blank" class="hover:underline hover:text-blue">Pendampingan Digital Safety
                                    Sebagai Precaution Penipuan Digital Di Desa Sidomukti Mayang</a>
                                 <p class="text-xs text-gray-500 line-clamp-3">Taufiq Timur Warisaji - 2022/12/31 -
                                    Jurnal: ABDIMASTEK</p>
                                 <div class="border"></div>
                              </li>
                              <li class="px-4 py-2">
                                 <a href="http://ejurnal.unmuhjember.ac.id/index.php/manage/article/download/753/222"
                                    target="_blank" class="hover:underline hover:text-blue">Pelatihan CorelDraw Untuk
                                    Desain Grafis Bagi Siswa SMA Negeri I Grujugan</a>
                                 <p class="text-xs text-gray-500 line-clamp-3">Taufiq Timur Warisaji - 01/08/2023 -
                                    Jurnal Pengabdian Masyarakat Manage</p>
                                 <div class="border"></div>
                              </li>
      ...
      <!-- OOOOOOOOOOOOOOOOOOO END RISET OOOOOOOOOOOOOOOOOOOOOOO ----------------------------------------------------------------------------------- -->
                ...
                <div class="grid lg:grid-cols-4 gap-8 sm:gap-6 sm:grid-cols-4 px-20">
                    ...
                    <div>
                        ...
                        <ul class="text-gray-500 dark:text-gray-400 font-medium">
                            ...
                            <li class="mb-4">
                                <a href="https://www.webometrics.info/en/search/Rankings/unmuhjember.ac.id"
                                    target="_blank" class="hover:underline hover:text-white">Webomatrics</a>
                            </li>
                            <li class="mb-4">
