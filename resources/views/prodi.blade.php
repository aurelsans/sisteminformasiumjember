...
<body class="font-sans">
    ...
    <!-- end drawer-->
      ...
      <!-- 8888888888888888888888888888 START PRODI 88888888888888888888888888888888888 --------------------------------------------------------- -->
         <section class="bg-white dark:bg-gray-900">
            <div class="py-12 px-4 mx-auto max-w-screen-xl text-center lg:py-20"></div>
         </section>

         <section
            class="bg-fixed bg-center bg-no-repeat radial-gradient(at right top, rgb(17, 24, 39), rgb(100, 116, 139), rgb(243, 244, 246)) bg-gray-700 bg-blend-multiply">
            <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-16">
               <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">
                  Program Studi</h1>
               <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Sistem Informasi.
               </p>
            </div>
         </section>

      </div>
      <!-- 8888888888888888888888888888 END PRODI 88888888888888888888888888888888888  ----------------------------------------------------------------------------------- -->
