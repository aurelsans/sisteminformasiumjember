...
<body class="font-sans">
    ...
    <nav class="flex mt-8 px-10 mx-auto max-w-screen-xl text-center" aria-label="Breadcrumb">
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    <li class="inline-flex items-center">
    <svg class="w-3 h-3 me-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
          <path d="m19.707 9.293-2-2-7-7a1 1 0 0 0-1.414 0l-7 7-2 2a1 1 0 0 0 1.414 1.414L2 10.414V18a2 2 0 0 0 2 2h3a1 1 0 0 0 1-1v-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 0 1 1h3a2 2 0 0 0 2-2v-7.586l.293.293a1 1 0 0 0 1.414-1.414Z"/>
        </svg>
      <a href="/indexsi" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
        Beranda
      </a>
    </li>
    <li aria-current="page">
      ...
      <svg class="rtl:rotate-180 w-3 h-3 text-gray-400 mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
        ...
        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Kehidupan Kampus</span>
      </div>
    </li>
  </ol>
</nav>
            ...
            <div class="bg-white dark:bg-gray-900">
                <div class="mx-auto px-4 sm:container">
                    <div class="border-blue-100 border-l-[5px] pl-5">
                        ...
                        Kehidupan kampus adalah periode penting dalam perkembangan pribadi dan akademis seseorang.
                         Ini adalah waktu di mana mahasiswa tidak hanya belajar untuk mendapatkan gelar, tetapi juga membangun hubungan, 
                         menemukan minat dan tujuan hidup, serta menjalani pengalaman yang membentuk identitas mereka sebagai individu.
                        </p>
                    </div>
                </div>
            </div>
            <!-- TW Elements is free under AGPL, with commercial license required for specific uses. See more details: https://tw-elements.com/license/ and contact us for queries at tailwind@mdbootstrap.com --> 
<div class="px-12 grid-cols-1 sm:grid md:grid-cols-3 ">
  <div
    ...
    <a href="/ospekawal">
      <img
        class="rounded-t-lg"
        src="gambar/ospekawal.jpeg"/>
    </a>
    <div class="p-6">
      <h5
        class="mb-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">
        Ospek Fakultas 6 Sept 2023.
      </h5>
  ...
  <div
    ...
    <a href="/ospekakhir">
      <img
        class="rounded-t-lg"
        src="gambar/ospekakhir.jpeg"/>
    </a>
    <div class="p-6">
      <h5
        class="mb-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">
        Malam Penutupan Ospek 13 November.
      </h5>
      <p class="mb-4 text-base text-neutral-600 dark:text-neutral-200">
      Hari terakhir atau penutupan yang dimana pada penutupan ini dilaksanakan pada tanggal 13 November 2023.
      </p>
    </div>
  </div>
</div>
