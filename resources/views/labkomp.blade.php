...
<body class="font-sans">
  ...
  <ol class="mt-12 flex flex-wrap items-center w-full px-12 rounded-md bg-blue-gray-50 bg-opacity-60">
   ...
   <div class="py-2 mx-auto max-w-screen-xl lg:py-8">
   <div class="px-2 xs:py-2 mx-auto max-w-screen-xl mx-auto sm:container flex items-center">
                     <h2 class="md:p-4 ml-0 text-cyan-800 mb-2 text-lg sm:text-3xl md:text-4xl font-bold dark:text-white mx-4">Laboratorium Komputer</h2>
                        <div class="flex-grow border-t-4 border-blue-100 dark:border-gray-700"></div>
                  </div>
      <div class="grid px-8 lg:grid-cols-2 gap-2 place-items-center">
         
<figure class="relative">
  <a href="/labkompa">
    <img class="max-w-full h-96 bg-white shadow dark:bg-gray-800 object-cover" src="gambar/kompaicon.png" alt="image description">
    <div class="absolute inset-0 bg-gradient-to-r from-[#1e2026] to-[#000000] opacity-50"></div>
  </a>
  <figcaption class="absolute px-4  text-3xl text-white bottom-6">
      <p><b>Laboratorium Komputer 4.1A</b></p>
  </figcaption>
</figure>
<figure class="relative">
  <a href="/labkompb">
    <img class="max-w-full h-96 bg-white shadow dark:bg-gray-800 object-cover" src="gambar/kompbicon.jpg" alt="image description">
    <div class="absolute inset-0 bg-gradient-to-r from-[#1e2026] to-[#000000] opacity-50"></div>
  </a>
  <figcaption class="absolute px-4  text-3xl text-white bottom-6">
      <p><b>Laboratorium Komputer 4.1B</b></p>
  </figcaption>
</figure>
