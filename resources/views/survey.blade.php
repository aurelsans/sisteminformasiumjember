...
<!-- rrrrrrrrrrrrrrrr START SURVEY rrrrrrrrrrrrrrrrrrr --------------------------------------------------------- -->
         ...
         <section
            ...
            <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-16">
               <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">
                  Survey</h1>
               <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Prodi Sistem
                  Informasi.
               </p>
            </div>
         </section>
      ...
      <!-- rrrrrrrrrrrrrrrr END SURVEY rrrrrrrrrrrrrr  ----------------------------------------------------------------------------------- -->
