...
<body class="font-sans">
    ...
    <!-- end drawer-->
      ...
      <!-- xxxxxxxxxxxxxxxxxxxxxx START SAMBUTAN xxxxxxxxxxxxxxxxxxxxxxxxx --------------------------------------------------------- -->
      ...
      <div class="flex grid items-center lg:grid-cols-2">
        <div class="mb-12 lg:mb-0">
          <div
            ...
            <h1 class="mt-0 text-2xl text-center font-bold pt-8 lg:pt-0">Sambutan Ketua Prodi</h1>
                        <div class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25"></div>
                        <h1 class="mt-0 text-2xl text-center font-bold pt-8 lg:pt-0">Agung Nilogiri S. T, M.Kom.</h1>
            <p class="mt-2 text-sm text-neutral-500 dark:text-neutral-300">
            Assalamualaikum Warahmatullahi Wabarakatuh, Selamat datang di website Program Studi Sistem Informasi Universitas Muhammadiyah
                           Jember.
                           Kami sangat berterima kasih atas ketertarikan Anda terhadap program studi kami.
                           Program Studi Sistem Informasi kami mempersiapkan lulusan sebagai tenaga ahli dalam
                           membangun
                           sistem berbasis komputer, baik terkait dengan aplikasi/solusi bisnis dan industri
                           maupun
                           terkait dengan pendukungnya.
                           Kami menyiapkan kurikulum terbaru yang menerapkan sepenuhnya kebijakan Merdeka
                           Belajar
                           Kampus
                           Merdeka.
                           Salah satunya mahasiswa dapat menempuh sejumlah mata kuliah di luar program studi
                           sistem
                           informasi.
                           Untuk mendukung proses pembelajaran, tersedia berbagai fasilitas pendukung yang
                           representatif, mulai dari ruang kuliah,
                           laboratorium, koneksi internet, hingga e-learning dan e-study.
                           Mari bergabung dan berkembang bersama kami! Wassalamu’alaikum warahmatullahi wabarakatuh.
                           </div>
        </div>

        <div>
        <img src="gambar/agungnilogiri.jpg"
            class="w-full object-cover object-top h-96 rounded-lg shadow-lg dark:shadow-black/20" alt="image" />
        </div>
      </div>
    </div>
    <!-- Jumbotron -->
...
<!-- Container for demo purpose -->
      <!-- xxxxxxxxxxxxxxxxxxxxxx END SAMBUTAN xxxxxxxxxxxxxxxxxxxxxxxxx  ----------------------------------------------------------------------------------- -->
