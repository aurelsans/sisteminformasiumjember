                    ...
                    <li class="text-body-color dark:text-dark-6 flex text-base">
                        <span
                           class="ml-2 bg-cyan-400 mr-2 mt-2.5 flex h-2 w-full max-w-[8px] items-center justify-center rounded-full text-base">
                            ...
                            <p class="text-md text-slate-600"><b>Merek PC:</b> Lenovo (24 buah).</p>
                     </li>
                     <li class="text-body-color dark:text-dark-6 flex text-base">
                        <span
                           class="ml-2 bg-cyan-400 mr-2 mt-2.5 flex h-2 w-full max-w-[8px] items-center justify-center rounded-full text-base">
                        </span>
                            <p class="text-md text-slate-600"><b>Mini PC:</b> Lenovo (23 buah).</p>
                     </li>
                     <li class="text-body-color dark:text-dark-6 flex text-base">
                        <span
                           class="ml-2 bg-cyan-400 mr-2 mt-2.5 flex h-2 w-full max-w-[8px] items-center justify-center rounded-full text-base">
                        </span>
                            <p class="text-md text-slate-600"><b>Processor:</b> Intel Core i3-3217U.</p>
                     </li>
                     <li class="text-body-color dark:text-dark-6 flex text-base">
                        <span
                           class="ml-2 bg-cyan-400 mr-2 mt-2.5 flex h-2 w-full max-w-[8px] items-center justify-center rounded-full text-base">
                        </span>
                            <p class="text-md text-slate-600"><b>RAM:</b> 4 GB DDR3.</p>
                     </li>
                     <li class="text-body-color dark:text-dark-6 flex text-base">
                        <span
                           class="ml-2 bg-cyan-400 mr-2 mt-2.5 flex h-2 w-full max-w-[8px] items-center justify-center rounded-full text-base">
                        </span>
                            <p class="text-md text-slate-600"><b>HDD:</b> 500 GB.</p>
                     </li>
                     <li class="text-body-color dark:text-dark-6 flex text-base">
                        <span
                           class="ml-2 bg-cyan-400 mr-2 mt-2.5 flex h-2 w-full max-w-[8px] items-center justify-center rounded-full text-base">
                     ...
                     <li class="text-body-color dark:text-dark-6 flex text-base">
                        <span
                           class="ml-2 bg-cyan-400 mr-2 mt-2.5 flex h-2 w-full max-w-[8px] items-center justify-center rounded-full text-base">
                            ...
                            <p class="text-md text-slate-600"><b>Spesifikasi Monitor:</b> Lenovo 17''.</p>
                     </li>
                     <li class="text-body-color dark:text-dark-6 flex text-base">
                        <span
                           class="ml-2 bg-cyan-400 mr-2 mt-2.5 flex h-2 w-full max-w-[8px] items-center justify-center rounded-full text-base">
                        </span>
                            <p class="text-md text-slate-600"><b>Keyboard:</b> Lenovo (24 buah).</p>
                     </li>
                     <li class="text-body-color dark:text-dark-6 flex text-base">
                        <span
                           class="ml-2 bg-cyan-400 mr-2 mt-2.5 flex h-2 w-full max-w-[8px] items-center justify-center rounded-full text-base">
                        </span>
                            <p class="text-md text-slate-600"><b>Mouse:</b> Lenovo (22 buah), A4tech (1 buah), dan Acer (1 buah).</p>
                     </li>
                  ...
                  <rect width="20" height="20" fill="white" />
                        ...
                        <div>
                            <div class="font-bold text-lg text-slate-700">Kursi</div>
                                <p class="text-sm mb-2 text-slate-600">Terdapat 13 kursi merk Chitose untuk kenyamanan mahasiswa.</p>
                            </div>
                     </li>
                  ...
                  <rect width="20" height="20" fill="white" />
                        ...
                        <div>
                            <div class="font-bold text-lg text-slate-700">AC</div>
                                <p class="text-sm mb-2 text-slate-600">AC merk Sharp dengan kapasitas 2PK untuk menjaga suhu 
            ...
            <defs>
               <clipPath id="clip0_980_24852">
                  <rect width="20" height="20" fill="white" />
                        ...
                        <div>
                            <div class="font-bold text-lg text-slate-700">Tabung Pemadam Kebakaran</div>
                                <p class="text-sm mb-2 text-slate-600">Untuk keamanan tambahan dalam mengantisipasi kebakaran.</p>
                            </div>
                     </li>
