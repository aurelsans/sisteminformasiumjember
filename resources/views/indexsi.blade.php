...
<div class="rounded-md overflow-hidden mt-8 bg-white sm:w-64 md:w-80 lg:w-80">
   <img src="gambar/fotoprestasi1.jpg" alt="Image Caption" class="transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0 w-full h-56 object-cover shadow-lg w-full"/>
   <div class="px-6 py-4">
      <div class="font-bold text-xl mb-2 text-slate-700">Juara Satu E-Sports MLBB</div>
      <p class="text-sm text-slate-600">SISFO CUP 2023 Se-Jawa Timur.</p>
   </div>
</div>
<div class="rounded-md overflow-hidden mt-8 bg-white sm:w-64 md:w-80 lg:w-80">
   <img src="gambar/panahan.jpg" alt="Image Caption" class="transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0 w-full h-56 object-cover shadow-lg w-full"/>
   <div class="px-6 py-4">
      <div class="font-bold text-xl mb-2 text-slate-700">Juara 3 Barebow Umum.</div>
      <p class="text-sm text-slate-600">Kejuaraan panahan Piala Gubernur Jawa Timur 2022.</p>
   </div>
</div>
<div class="rounded-md overflow-hidden mt-8 bg-white sm:w-64 md:w-80 lg:w-80">
   <img src="gambar/china.png" alt="Image Caption" class="transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0 w-full h-56 object-cover shadow-lg w-full"/>
   <div class="px-6 py-4">
      <div class="font-bold text-xl mb-2 text-slate-700">China-ASEAN Education Cooperation Week</div>
      <p class="text-sm text-slate-600">2ⁿᵈ International Invitational Contest of Internet of Things Technology.</p>
   </div>
</div>
                  </div>
